...
// Add the export related options
    defaultOptions.exporting = {
        ...
        //filename: 'chart',
        type: 'image/png',
        url: 'http://10.58.71.244:8666/dashboard_export_chart/',
...
// Add the Highcharts.post utility
    ...
    extend(Chart.prototype, {
        ...
        exportChart: function (options, chartOptions) {
            ...
            var d = new Date();
            d.yyyymmdd();
            var filenameExport = (chart.title ? change_alias(chart.title.textStr) + '_' + d.yyyymmdd() : 'chart');
            // do the post
            Highcharts.post(options.url, {
                filename: filenameExport || 'chart' + '_' + d.yyyymmdd(),
                type: options.type,
    ...
    function change_alias(alias) {
        var str = alias;
        str= str.toLowerCase();
        str= str.replace(/à|á|à|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ  |ặ|ẳ|ẵ/g,"a");
