...
import {AreaModel, ProvinceModel} from '../../../../../models/org.model';

@Component({
  selector: 'partner-manage-regional-organiztion',
  templateUrl: './manage-regional-organiztion.component.html',
  styleUrls: ['./manage-regional-organiztion.component.scss']
})
export class PartnerManageRegionalOrganiztionComponent implements OnInit {
  ...
  marrchildSearchProvice: ProvinceModel;
  employeeCode: string;
  employeeName: string;
  ...
  clickSearch() {
    this.marrchildSearchProvice = new ProvinceModel;
    this.marrchildSearchProvice.children = [];
    const objDataProvince = new ProvinceModel;
    console.log('this.selected', this.value);
    console.log('this.selected.....', this.value.value);
    ...
    this.configRegionalOrganization.searchTree(objDataProvince).subscribe(data => {
      ...
      this.marrchildSearchProvice.children = data['data'];
      console.log('this.marrchildSearch', !this.marrchildSearchProvice);
      console.log('this.marrchildSearchđâsd', !this.marrchildSearchProvice.children);
