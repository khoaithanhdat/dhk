...
public class RevenueDaily {
    ...
    private double mdblFValueMonth;
    ...
    @Basic
    @Column(name = "F_VALUE_MONTH")
    public double getfValueMonth() {
        return mdblFValueMonth;
    }

    public void setfValueMonth(double pdblFValueMonth) {
        this.mdblFValueMonth = pdblFValueMonth;
    }
