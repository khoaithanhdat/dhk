...
@Component
public class KpiActionProgramWriter {
    ...
    public ByteArrayInputStream write(Class pclsClazz) throws Exception {
        ...
        String[] columns = new String[]{I18N.get("common.header.order"), I18N.get("column.excel.province.code"),
                I18N.get("common.header.staff"), I18N.get("note.chart.kh"),I18N.get("note.chart.th"),
                I18N.get("column.excel.density")};
        ...
        tableCell.setCellValue(I18N.get("table.name.kpi.action").toUpperCase());
